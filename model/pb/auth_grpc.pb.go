...
func (c *authClient) SignUp(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
...
func (UnimplementedAuthServer) SignUp(context.Context, *UserRequest) (*UserResponse, error) {
